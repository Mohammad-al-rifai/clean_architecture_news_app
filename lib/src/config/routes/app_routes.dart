import 'package:clean_news_app/src/domain/entities/article.dart';
import 'package:clean_news_app/src/presentation/views/article_details_view.dart';
import 'package:clean_news_app/src/presentation/views/saved_articles_view.dart';
